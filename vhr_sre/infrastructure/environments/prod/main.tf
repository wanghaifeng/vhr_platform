...
module "vpc" {
  ...
  dr_cidr       = "10.16.4.0/24" # Different CIDR for DR VSwitch
...
module "ack" {
  ...
  dr_vswitch_ids    = [module.vpc.dr_vswitch_id] # Fixed: Use real DR VSwitch in different zone
