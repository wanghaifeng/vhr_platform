output "namespace_name" {
  ...
  value       = alicloud_cr_namespace.main.namespace_name
}

output "frontend_repo_name" {
  description = "Frontend repository full name"
  value       = alicloud_cr_repo.frontend.repo_name
}

output "frontend_repo_url" {
  description = "Frontend repository URL"
  value       = "registry.${var.region}.aliyuncs.com/${alicloud_cr_namespace.main.namespace_name}/frontend"
}

output "backend_repo_name" {
  description = "Backend repository full name"
  value       = alicloud_cr_repo.backend.repo_name
}

output "backend_repo_url" {
  description = "Backend repository URL"
  value       = "registry.${var.region}.aliyuncs.com/${alicloud_cr_namespace.main.namespace_name}/backend"
}
